...
from tests.steps import start_patents_page, sign_in_patents_page, open_patents_page, open_filter_value_patents, open_filter_patents, open_data_filter_patents


@allure.label('owner', 't.sadykov')
@allure.label('component', 'OPN')
@allure.epic('OPN')
@allure.story('Выбор значения фильтра')
@allure.title('Проверка выбора значения фильтра')
@allure.severity(allure.severity_level.BLOCKER)
@pytest.mark.parametrize('browser', CLIENT_BROWSERS)
@pytest.mark.parametrize('device_type', CLIENT_DEVICE_TYPE)
def test_filter_patents(
