def pytest_addoption(parser):
    ...
    parser.addoption('--user', action='store', dest='username', type=str, default='dit_bot', help='Username')
    parser.addoption('--password', action='store', dest='password', type=str, default='y,F!89Qk&,2n', help='Password')
